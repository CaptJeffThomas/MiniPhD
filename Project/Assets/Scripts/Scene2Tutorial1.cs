...
public class Scene2Tutorial1 : MonoBehaviour{

	public string windowTitle = "Tutorial";
	public string text = "Blue Virii can only be hurt by your Extradimensional PhazerCannon!  Fire the Cannon with the E key.";
